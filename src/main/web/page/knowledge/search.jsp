...
<div id="content">
    <form action="Knowledge!findByField.action" method="post">
    ...
    <form action="Knowledge!findByField.action" method="post" id="myform">
        <input type="hidden" name="page" value="1" id="page"/>
        <input type="hidden" name="msg" value="${msg}">
        <input type="hidden" name="noticeType" value="${subject}">
        <table
            ...
            <s:iterator value="pageView.records" var="knowledges" status="k">
