...
<div id="content">
    <form action="Promotion!findPromotionByField.action" method="post">
    ...
    <form action="ProductInfo!findProductByField.action" method="post" id="myform">
        ...
        <table
            ...
            <s:iterator value="pageView.records" var="promotions" status="p">
                <tr style="background-color: #F8FBFE"
                    ...
                    <td>
                        <fmt:formatDate value="${promotions.createTime}" pattern="yyyy-MM-dd"/>
                    </td>
                </tr>
            </s:iterator>
        </table>
