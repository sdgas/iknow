...
<div id="content">
    <form action="GovDoc!findByField.action" method="post">
    ...
    <form action="GovDoc!findByField.action" method="post" id="myform">
        <input type="hidden" name="page" value="1" id="page"/>
        <input type="hidden" name="msg" value="${subject}">
        <table
            ...
            <s:iterator value="pageView.records" var="govDoc" status="g">
                <tr style="background-color: #F8FBFE"
                    ...
                    <td>
                        <a href="FileDownload.action?flag=1&fileName=${govDoc.file}">${govDoc.file}</a>
                    </td>
                </tr>
            </s:iterator>
        </table>
